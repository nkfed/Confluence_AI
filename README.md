...
Детальна документація доступна у папці `docs/`:

- **[Prompt Engineering Guide](docs/PROMPT_ENGINEERING.md)** - Повний гід по створенню та керуванню промптами для AI
  - Архітектура промптів
  - Створення нових промптів
  - Налаштування параметрів
  - Best practices та troubleshooting

- **[Testing Guidelines](docs/TESTING_GUIDELINES.md)** - Правила створення та організації тестів
  - ✅ Всі тести тільки в папці `tests/`
  - Naming conventions
  - Best practices для pytest
  - Running tests та fixtures
