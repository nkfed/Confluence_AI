...
def generate_page_summary(page_id: str) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        result = service.summarize_page(page_id)
        return result
...
def generate_and_update_page_summary(page_id: str) -> Dict[str, Any]:
    """
    ...
    try:
        service = SummaryService()
        result = service.summarize_and_update_page(page_id)
        return result
